 ...
 * @LastEditTime: 2020-09-29 08:47:45
  ...
  data() {
    return {
      ...
      baseInfo: {
        ...
        isWxmb: false, // 是否开启微信密保
        isScan: false, // 是否开启扫码支付
        chargetype: '', // 充值方式
        gameName: '', // 游戏币名称
        color: 0, // 游戏币颜色
        command: '', // 脚本命令
      ...
      this.$api.partmodule
        ...
        .then((data) => {
          if (data.status === 200) {
            ...
            this.baseInfo.isWxmb = data.data.isWxmb !== 0;
            this.baseInfo.isScan = data.data.isScan !== 0;
            ...
            this.baseInfo.safetyMoney = data.data.safetyMoney;
      ...
      if (this.editFlag) {
        ...
        this.$api.partmodule
          .editModule({
            ...
            isWxmb: this.baseInfo.isWxmb ? 1 : 0,
            isScan: this.baseInfo.isScan ? 1 : 0,
